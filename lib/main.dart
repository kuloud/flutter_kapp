...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  Future<void> initPlatformState() async {
    Uri redirectUrl;
    String clientId =
        'BDEGQCSuEq6bE8wL-mub4o9EyR8RxN2v5FfEPe-MvbHMQdN4gIpxtw70s2if-hyftPjG40XHgv7EpFPVtypGXnk';
    if (Platform.isAndroid) {
      redirectUrl = Uri.parse('w3a://com.example.flutter_kapp');
    } else if (Platform.isIOS) {
      redirectUrl = Uri.parse('com.example.flutterKapp://auth');
    } else {
